// File name: Expression_Tree_Iterator.h
// Author: Nishant Jain
// VUnetID: jainn6
// Email: nishant.jain@vanderbilt.edu
// Class: CS3251
// Assignment Number: 7
// Description: This class defines a Expression_Tree_Iterator data structure.
...
private:
    Refcounter<Expression_Tree_Iterator_Impl> impl;
};
